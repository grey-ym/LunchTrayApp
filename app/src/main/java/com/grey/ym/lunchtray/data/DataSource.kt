package com.grey.ym.lunchtray.data
...
object DataSource {
    val entreeMenuItems = listOf(
        ...
        EntreeItem(
            ...
            description = "Black beans, red beans, slow cooked, topped with onion",
            price = 4.00
        ),
        EntreeItem(
            name = "Mushroom Pasta",
        ...
        EntreeItem(
            ...
            description = "Seasonal vegetables, black beans, house spiced blend, served with avocado and quick pickled onions",
            price = 5.50
        )
    )
    ...
    val accompanimentMenuItems = listOf(
        ...
        AccompanimentItem(
            name = "Mixed Berries",
            description = "Strawberries, blueberries, raspberrie, and huckleberries",
            price = 1.00
        ),
        AccompanimentItem(
