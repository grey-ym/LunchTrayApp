...
import com.grey.ym.lunchtray.data.DataSource.sideDishMenuItems
import com.grey.ym.lunchtray.data.DataSource.accompanimentMenuItems
...
fun CheckoutScreenPreview() {
    CheckoutScreen(
        orderUiState = OrderUiState(
            entree = entreeMenuItems[0],
            sideDish = sideDishMenuItems[0],
            accompaniment = accompanimentMenuItems[0],
